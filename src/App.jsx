...
import SignUp from './pages/SignUpAndManageUser/SignUp/SignUp';
import UserManager from './pages/SignUpAndManageUser/UserManager/UserManager';
  ...
  return (
    <div>
      ...
      <Switch>
        ...
        <CyberbugsTemplate exact path='/userManager' Component={UserManager} />
