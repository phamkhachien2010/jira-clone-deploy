    ...
    return (
        <div className="menu">
            ...
            <div className="control">
                ...
                <div>
                    <i className="fa fa-cog mr-1" /> 
                    <NavLink className="text-dark"  activeStyle={{color:'blue'}} to='/userManager' activeClassName="active font-weight-bold  text-primary" >Manager User</NavLink>
                </div>
            ...
            <div className="feature">
                ...
                <button className="btn btn-primary mr-1">
                    <NavLink className='text-dark font-weight-bold' style={{fontSize:12}} to='/login'>Login</NavLink>
                </button>
                <button className="btn btn-primary">
                    <NavLink className='text-dark font-weight-bold' style={{fontSize:12}} to='/signUp'>Sign up</NavLink>
                </button>
            </div>
        </div>
